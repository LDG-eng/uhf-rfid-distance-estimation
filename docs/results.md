...
- Short-range regions (0.1m–0.7m) show high baseline accuracy.
- Significant improvement observed at 1.6m in accuracy (0.0% → 64.3%).
- RMSE reduction indicates effective suppression of extreme RSSI spikes.
- Mid-range distances (1.0m–1.3m) show persistent instability due to RSSI fluctuation characteristics.
